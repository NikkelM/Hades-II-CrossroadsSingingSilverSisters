...
local function loadMusicBank()
	rom.audio.load_bank(rom.path.combine(_PLUGIN.plugins_data_mod_folder_path, "Audio\\ModsNikkelMCrossroadsSingingSilverSistersMusic.bank"))
end
